...
public:
    ...
    PLT_MicroMediaController(PLT_CtrlPointReference& ctrlPoint,PltMediaInterface * delegateWrapper);
...
public:
    ...
    PLT_MediaObject* create_didl_from_path(NPT_String	path);
